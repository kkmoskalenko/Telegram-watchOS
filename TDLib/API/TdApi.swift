...
public final class TdApi {
    ...
    /// - Parameter memberLimit: Maximum number of chat members that can join the chat by the link simultaneously; 0-99999; pass 0 if not limited
    ...
    /// - Parameter limit: Maximum number of invite links to return
    ...
    /// - Parameter limit: Maximum number of chat members to return
    ...
    /// - Parameter payload: Group join payload, received from tgcalls. Use null to cancel previous joinGroupCall request
    ...
    /// - Parameter limit: Maximum number of participants to load
